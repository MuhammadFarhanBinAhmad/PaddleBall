...
public class BookAbilityInfoUI : MonoBehaviour
{
    ...
    public void BuildStore(STATUSTYPE _type = STATUSTYPE.EXPLOSION)
    {
    ...
    void PopulateLevel0()
    {
        ...
        BallAbilityLookUpStatsUI ui =
            _lvl0AbilityButton.GetComponent<BallAbilityLookUpStatsUI>();
                  ...
                  List<SOStoreAbilityContent> abilities)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            BallAbilityLookUpStatsUI ui =
                buttons[i].GetComponent<BallAbilityLookUpStatsUI>();
